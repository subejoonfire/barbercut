<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Topbar.ascx.vb" Inherits="barbercut.Topbar" %>
...
<img class="img-profile rounded-circle" src="/img/logobarber.jpg">
</a>
