<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="barbercut.Login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>Login - Executes Barber</title>
     ...
     <table style="width: 100%; height: 100%; border: 0;">
        <tr>
            <td style="text-align: center; vertical-align: middle;">
                <img src="/img/logobarber.jpg" alt="Logo Politala" width="300" />
            </td>
        </tr>
    </table>
</div>
