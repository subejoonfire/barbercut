<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BarberEdit.aspx.vb" Inherits="barbercut.BarberEdit" %>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:Label ID="LabelIdBarber" runat="server" Text="Id Barber"></asp:Label>
                                    <asp:TextBox ID="txtIdBarber" readonly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="form-group">
