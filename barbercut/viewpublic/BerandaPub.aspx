<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BerandaPub.aspx.vb" Inherits="barbercut.BerandaPub" %>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Ubahlah Sekarang Penampilan Anda</h1>
            <p>We are team of talented designers making websites with Bootstrap</p>
           
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
            <img id="imgBarber" src="ImagePage.aspx" />
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <% 
                ...
                For Each row As System.Data.DataRow In dt.Rows
                            %>
                            chart.data.labels.push('<%= row("grafik_nama") %>');
                            chart.data.datasets[0].data.push(<%= row("grafik_total") %>);
                            <%
                Next
                    %>
                            chart.update();
    ...
    <section id="team" class="team section">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
         ...
         <asp:GridView ID="GV" runat="server" AutoGenerateColumns="True" CssClass="table table-striped" />
        </div>
